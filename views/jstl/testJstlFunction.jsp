...
<body>
	...
	<h3>문자열 처리와 관련된 함수들이다.</h3>
	<h3>el 안에서 값처리 용으로 사용되거나 value 속성에 대입시에 사용 됨</h3>
	<c:set var="str" value="How are you?"/>
	
	str:${str }
	you가 포함되어 있나 : ${fn:contains(str, 'you') }<br>
	how가 포함되어 있나 : ${fn:contains(str, 'how') }<br>
	대소문자 구분없이 how 포함되어 있는지 확인 : ${fn:containsIgnoreCase(str,'how') }<br>
